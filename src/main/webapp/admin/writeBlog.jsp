...
<script type="text/javascript" charset="utf-8"
	src="${pageContext.request.contextPath}/static/ueditor1_4_3_3/ueditor.all.js">
...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.post("${pageContext.request.contextPath}/admin/blog/save.do",{'title':title,'content':content,'blogType.id':blogTypeId,'summary':summary,'keyWord':keyWord,'contentWithoutTag':UE.getEditor("editor").getContentTxt()},
				function(result){
				if(result.success){
...
<table cellspacing="20px">
	...
	<tr>
		<td>关键字</td>
		<td><input type="text" id="keyWord" name="keyWord" style="width:959px;"/>
		&nbsp;(多个关键字中间用空格隔开)</td>
	</tr>
	<tr>
		<td></td>
