...
<head>
    ...
    <style type="text/css">
        body {
            ...
            padding: 0;
            margin: 0;
            background-image: url(${pageContext.request.contextPath}/static/images/31.jpg);
...
<div region="north" style="width:100%;height: 35px; background-color: #E0ECFF">
    <div style="width: 49%;height:  35px;float: left">
        <h2>Clown 杨兴卓的博客后台管理</h2>
    </div>
    <div style="width: 49%;height: 35px;text-align: right;float: right">
...
<div region="center">
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 100px"><font color="red" size="10">欢迎使用Clown的博客后台管理</font></div>
        </div>
    </div>
</div>
<%-- 左边导航菜单--%>
