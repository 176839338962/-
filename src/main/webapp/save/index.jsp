...
<!-- Page Header -->
<header class="masthead" style="background-image: url('${pageContext.request.contextPath}/static/img/92.jpg')">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Clown's Blog</h1>
                    <span class="subheading">我想让我的知识有个家</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            <div style="float:right;">
                <form action="${pageContext.request.contextPath}/blog/q.html" method="post" onsubmit="return checkData()">
                    <h5>全文检索</h5>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                ...
                <p class="copyright text-muted">Copyright &copy; Clown 杨兴卓 2020</p>
            </div>
        </div>
    </div>
</footer>
